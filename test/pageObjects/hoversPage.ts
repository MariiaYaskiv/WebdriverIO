...
export default class Hovers extends RootObject {
  ...
  get user1(): Promise<WebdriverIO.Element> {
    return $("div.figure:nth-child(3) > img:nth-child(1)");
  }
  get user1Profile(): Promise<WebdriverIO.Element> {
    return $("div.figure:nth-child(3) > div:nth-child(2)");
  }

  get user2(): Promise<WebdriverIO.Element> {
    return $("div.figure:nth-child(4) > img:nth-child(1)");
  }
  get user2Profile(): Promise<WebdriverIO.Element> {
    return $("div.figure:nth-child(4) > div:nth-child(2)");
  }

  get user3(): Promise<WebdriverIO.Element> {
    return $("div.figure:nth-child(5) > img:nth-child(1)");
  }
  get user3Profile(): Promise<WebdriverIO.Element> {
    return $("div.figure:nth-child(5) > div:nth-child(2)");
  }

  async moveToElementFirst(options?: stepOptions): Promise<void> {
    await step(
      options,
  ...
  async getTextFirst(options?: stepOptions): Promise<void> {
    await step(
      options,
      ...
      async () => {
        const user1Profile = await $(
          "div.figure:nth-child(3) > div:nth-child(2)"
        );
  ...
  async moveToElementSecond(options?: stepOptions): Promise<void> {
    await step(
      options,
  ...
  async getTextSecond(options?: stepOptions): Promise<void> {
    await step(
      options,
      ...
      async () => {
        const user2Profile = await $(
          "div.figure:nth-child(4) > div:nth-child(2)"
        );
  ...
  async moveToElementThird(options?: stepOptions): Promise<void> {
    await step(
      options,
  ...
  async getTextThird(options?: stepOptions): Promise<void> {
    await step(
      options,
      ...
      async () => {
        const user2Profile = await $(
          "div.figure:nth-child(5) > div:nth-child(2)"
        );
        await user2Profile.getText();
      }
    );
  }
  async clickOnTheLinkOne(
    status: string,
    options?: stepOptions
  ): Promise<void> {
    await step(
