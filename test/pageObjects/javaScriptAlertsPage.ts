...
export default class JavaScriptAlerts extends RootObject {
  ...
  async dropdownOneClick(text: string, options?: stepOptions): Promise<void> {
    await step(
      options,
  ...
  async dropdownTwoClick(text: string, options?: stepOptions): Promise<void> {
    await step(
      options,
  ...
  async dropdownThreeClick(text: string, options?: stepOptions): Promise<void> {
    await step(
      options,
