...
export default class TablesPage extends RootObject {
  ...
  async clickTableOneForthChild(options?: stepOptions): Promise<void> {
    await step(
      options,
  ...
  async clickTableOneThirthChild(options?: stepOptions): Promise<void> {
    await step(
      options,
      "Verify if the user can click and chose needed cell and the table will be sorted",
      "Check if the user can click and chose needed cell and the table will be sorted",
  ...
  async clickTableOneSecondhChild(options?: stepOptions): Promise<void> {
    await step(
      options,
      "Verify if the user can click and chose needed cell and the table will be sorted",
      "Check if the user can click and chose needed cell and the table will be sorted",
  ...
  async clickTableOneFirsthChild(options?: stepOptions): Promise<void> {
    await step(
      options,
      "Verify if the user can click and chose needed cell and the table will be sorted",
      "Check if the user can click and chose needed cell and the table will be sorted",
  ...
  async clickTableTwoFirstChild(options?: stepOptions): Promise<void> {
    await step(
      options,
      "Verify if the user can click and chose needed cell and the table will be sorted",
      "Check if the user can click and chose needed cell and the table will be sorted",
  ...
  async clickTableTwoSecondhChild(options?: stepOptions): Promise<void> {
    await step(
      options,
      "Verify if the user can click and chose needed cell and the table will be sorted",
      "Check if the user can click and chose needed cell and the table will be sorted",
  ...
  async clickTableTwoThirtChild(options?: stepOptions): Promise<void> {
    await step(
      options,
      "Verify if the user can click and chose needed cell and the table will be sorted",
      "Check if the user can click and chose needed cell and the table will be sorted",
