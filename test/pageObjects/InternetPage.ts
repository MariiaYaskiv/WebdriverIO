...
export default class Internet extends RootObject {
  ...
  async clickOnTheFirstLincAndItShoulBeDisplayed(
    options?: stepOptions
  ): Promise<void> {
    await step(
      options,
  ...
  async displayPageFooter(options?: stepOptions): Promise<void> {
    await step(
      options,
  ...
  async displayPageHeader(options?: stepOptions): Promise<void> {
    await step(
      options,
  ...
  async displayInViewportPageHeader(options?: stepOptions): Promise<void> {
    await step(
      options,
  ...
  async listOfItemsArrayOfSize(options?: stepOptions): Promise<void> {
    await step(
      options,
